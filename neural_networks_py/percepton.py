...
class Perceptron:
    ...
    def vectorized_forward_pass(self, input_matrix):
        ...
        # return input_matrix.dot(self.w) + np.ones((n,1))*self.b > 0
        return input_matrix.dot(self.w) > -1*self.b
    ...
    def train_on_single_example(self, example, y):
        ...
        """
        result = ( y-int(self.vectorized_forward_pass(example.T)[0][0]) )
        self.w += result*example
        self.b += result
        return result**2
...
# pr = p.vectorized_forward_pass(matrix)

# print(pr)
# print(mean_execution_time(100,100,10000))

# p.w = [[0,0]]
# p.b = 0
# r0 = p.train_on_single_example(np.array([[1,0.3]]), 1)
# r1 = p.train_on_single_example(np.array([[0.4,0.5]]), 1)
# r2 = p.train_on_single_example(np.array([[0.7,0.8]]), 0)
# print(r0, r1, r2)
