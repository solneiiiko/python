...
class Neuron:
    ...
    def __init__(self, weights, bias = 0, activation_function=sigmoid, activation_function_derivative=sigmoid_prime):
        """
...
def create_neuron(weights, bias=0):
...
x = np.array([0,1,1])
n1_1 = create_neuron(w_1[0])
n1_2 = create_neuron(w_1[1])
print(list(map(lambda n: n.summatory(x), [n1_1, n1_2])))
a_1 = np.array(np.concatenate(np.array([max(n1_1.summatory(x),0),n1_2.activation(n1_2.summatory(x))])))
print(a_1)
n2_1 = create_neuron(w_2)
a_2 = n2_1.forward_pass(a_1)
print(a_2)
n2_1.activation_function = sigmoid_prime
delta_out = (a_2 - 1)*n2_1.forward_pass(a_1)
print('delta_out: '+str(delta_out))

n1_1_prime = np.array(max_prime(n1_1.summatory(x)))
n1_2_prime = sigmoid_prime(n1_2.summatory(x))
prime_1 = np.array([n1_1_prime,n1_2_prime])
print(prime_1)
deltas_1 = w_2.T * delta_out * prime_1
print(deltas_1)

print('w_1 ^ 1_3: ' + str(x[2]*deltas_1[0][0]))
print('w_1 ^ 2_3: ' + str(x[2]*deltas_1[0][1]))
