...
NAME_SPACES = {'global':{'vars':set(), 'parent':None}}# ключ - название...vars=set(), parent='name'
def create_name_space(name_space, parent):
	NAME_SPACES[name_space]={'vars':set(),'parent': parent}

def add_var_in_name_space(name_space, var):
	NAME_SPACES[name_space]['vars'].add(var)

def find_name_space_for_var(current_namespace, var):
	if current_namespace==None:
		return None
	elif var in NAME_SPACES[current_namespace]['vars']:
		return current_namespace
	else:
		return find_name_space_for_var(NAME_SPACES[current_namespace]['parent'], var)


def run_request(req_name, name_space, var):
	if req_name=='create':
		create_name_space(name_space, parent=var)
	elif req_name=='add':
		add_var_in_name_space(name_space, var)		
	elif req_name=='get':
		print(find_name_space_for_var(name_space, var))
