...
client_id = '3b94ca2c9297c5bde551'
client_secret = 'd86a3d96d61e313c0a57a7155e2ad8b1'
...
with open('in2.txt') as f:
    names = f.read().split()
    for name in names:
        r = requests.get(url+name.rstrip(), headers=headers)
        j = json.loads(r.text) 
        res.append([int(j['birthday']), j['sortable_name']])
with open('out.txt', 'w', encoding='utf-8') as f:
    f.write('\n'.join([r[1] for r in sorted(res)]))
# print(sorted(res))
